...
S3_PREFIX="notifications-processor-artifacts-$ENV"

echo "Selected env: $ENV"
echo "Artifacts bucket: $ARTIFACTS_BUCKET/notifications-processor-artifacts-$ENV"

echo "Building notifications-processor-$ENV"
sam build --template-file ./cloudformation/template.yml --base-dir ./

echo "Uploading notifications-processor-$ENV artifacts"
